   ...
   return (
      <div id='projects'>
         ...
         <div className='flex flex-col md:flex-row gap-2 justify-center items-center '>
            ...
            <div className="card w-80 md:w-96 h-[500px] glass rounded-md">
               ...
               <div className="card-body">
                  ...
                  <div className='flex gap-1 flex-col md:flex-row'>
                     <Link to={"https://lexi-learn-66370.web.app/"}><button className="btn btn-success btn-xs"><FaCode />Live Site</button></Link>
            ...
            <div className="card w-80 md:w-96 h-[500px] glass rounded-md">
               ...
               <div className="card-body">
                  ...
                  <div className='flex gap-1 flex-col md:flex-row'>
                     <Link to={"https://toy-marketplace-client-s-60275.web.app/"}><button className="btn btn-success btn-xs"><FaCode />Live Site</button></Link>
            ...
            <div className="card w-80 md:w-96 h-[500px] glass rounded-md">
               ...
               <div className="card-body">
                  ...
                  <div className='flex gap-1 flex-col md:flex-row'>
                     <Link to={"https://chef-recipe-hunter-clien-ef342.web.app/"}><button className="btn btn-success btn-xs"><FaCode />Live Site</button></Link>
